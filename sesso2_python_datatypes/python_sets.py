...
cars = {"volvo", "subaru","markx"}
print(f"the total cars {len(cars)}")
print(f"the names of the cars are {cars}")
cars.add("prados")
print(f"The names of the cars are {cars}")
...
cars.remove("markx")
print(f"after remobing markx {len(cars)}, the fruits set contains {len(fruits)} items")
print(f"the name of the cars are {cars}")
